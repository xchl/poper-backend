    ...
    <div class="login-box-body">
        ...
        <form action="{{ admin_url('oauth/token') }}" method="post" id="loginForm">
            <div class="form-group has-feedback {!! !$errors->has('username') ?: 'has-error' !!}">
                ...
                <input type="text" class="form-control" required placeholder="{{ trans('admin.username') }}" name="username" value="{{ old('username') }}">
            ...
            <div class="form-group has-feedback {!! !$errors->has('password') ?: 'has-error' !!}">
                ...
                <input type="password" class="form-control" required placeholder="{{ trans('admin.password') }}" name="password">
